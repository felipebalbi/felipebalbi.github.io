...
This is the first post on the new version of [balbi.sh](/). The previous incarnation was a single HTML file with one link; this one is built with [Zola](https://www.getzola.org/) and styled after [ef-melissa-light](https://github.com/protesilaos/ef-themes) — a warm, legible Emacs theme by Protesilaos Stavrou. Body text is set in **Aporetic Serif**, headings and UI in **Aporetic Sans**, and code in **Aporetic Sans Mono** — all from the same author as the colour palette.
...
- **Bare-metal C** — when Rust isn't an option, which is more often than I'd like.
